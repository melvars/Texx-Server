...
class ProjectUrlMatcher extends Symfony\Component\Routing\Tests\Fixtures\RedirectableUrlMatcher
{
    ...
    public function match($rawPathinfo) {
        ...
        } else if (0 === strpos($pathinfo, '/trailing/regex')) {
        ...
        } else if (0 === strpos($pathinfo, '/not-trailing/simple')) {
        ...
        } else if (0 === strpos($pathinfo, '/not-trailing/regex')) {
